...
<%@page import="MisRutinas.ViewModel.VentasView"%>
<%@page import="MisRutinas.ViewModel.DetalleView"%>
...
<link href="estilos/detalleventa.css" rel="stylesheet" type="text/css"> 
</head>
<body>
	<%
	String IdVenta = request.getParameter("IdVenta");
	BD objB=new BD();
	VentasView venta=objB.FindVenta(IdVenta);
	%>
	...
	-->
	<div class="jsx-2409308707 main">
						<div class="jsx-4266298634 container priority jsx-2502541323">
							<div class="jsx-670243593 ">
								<div class="jsx-1270981281 jsx-3797767392 cell">
									<div class="jsx-3528442386 jsx-2925752641 cell">
										<div class="jsx-970983670 sodimac-label">Realizada en
											Cibertec.pe</div>
									</div>
									<div class="jsx-3791367950 container priority">
										<div class="jsx-2808028905 orderNumber-cell">
											<div class="jsx-3265409146 orderNumber-container">
												<div class="jsx-3265409146 orderNumber-back">
													<a href="javascript:history.back()"
														class="jsx-3265409146 svg-mobile"><svg
															viewBox="0 0 32 32"
															class="caret-right_svg__icon caret-right_svg__icon-chevron-right"
															aria-hidden="true" width="30" fill="#bbbbbb" rect="x=10"
															style="transform: scaleX(-1);">
															<path
																d="M18.629 15.997l-7.083-7.081L13.462 7l8.997 8.997L13.457 25l-1.916-1.916z"></path></svg></a>
												</div>
												<div class="jsx-3265409146 orderNumber-back-desktop">
													<a href="javascript:history.back()"
														class="jsx-3265409146 svg-desktop"><span
														class="jsx-3265409146 backToOrders">Volver a Mis
															compras</span></a>
												</div>
												<div class="jsx-3265409146 orderNumber-item">
													<div class="jsx-3265409146 orderNumber-title-text">Compra
														online</div>
												</div>
											</div>
										</div>
										<div class="jsx-2808028905 amount-cell">
											<div class="jsx-1149202316 amountInfo-container">
												<div class="jsx-1149202316 amountInfo-date-item">
													<div class="jsx-1149202316 amount-text-style">Fecha
														de la compra:</div>
													<div
														class="jsx-1149202316 amount-info-date info-data-style"><%=venta.getFechaVenta() %></div>
												</div>
												<div class="jsx-1149202316 amountInfo-info-item">
													<div
														class="jsx-1149202316 amount-text-style amount-info-mob">Total
														de la compra:</div>
													<div class="jsx-1149202316 info-data-style amount-info-mob">s/
														<%=venta.getMontoTotal() %></div>
												</div>
											</div>
										</div>
										<div class="jsx-2808028905 alert-cell"></div>
									</div>
								</div>
							</div>
							<div class="jsx-2451123962  cell">
								<div class="jsx-2160695441 container priority">									
									
									<div
										class="jsx-3975315105 jsx-3546111395 suborder-container cell">
										
										<div class="jsx-2765549500 subOrderDetailCell">
											<div class="jsx-1790677081 container priority">
												<div class="jsx-1389109146 jsx-34709862 subOrder-container">
													<div class="jsx-1389109146 jsx-34709862 product-item">
														<div class="jsx-1708367111 container priority">
															<h1 class="jsx-3564791919 title1 secondary   ">
																<div class="jsx-3975315105 jsx-1205755299 cell">
																	<div>Compras Nº<%=venta.getIdVenta() %></div>
																</div>
																<div class="jsx-3975315105 jsx-1159908352 cell">Entregada
																	el 10 de agosto.</div>
															</h1>
														</div>
														<%
														for(DetalleView det : venta.getDetalles()){
															
														%>
														<div class="jsx-1389109146 jsx-34709862 order-line">
															<div class="jsx-1357075663  cell">
																<div id="container-orderItem"
																	class="jsx-638642350 product-container">
																	<div class="jsx-2260178792  cell">
																		<div
																			class="jsx-3587637543 container priority jsx-2954533403">
																			<div
																				class="jsx-291111756 jsx-2954533403 jsx-1444736311 cell">
																				<a id="prod_link"
																					href="imagenes/<%=det.getImagen() %>"
																					target="_blank" rel="noopener noreferrer"
																					class="jsx-2954533403">
																					<img
																					src="imagenes/<%=det.getImagen() %>"
																					id="testId-OrderLine-productImg 92400494-2e2d-43bc-9e98-9969abc421e6"
																					alt="https://falabella.scene7.com/is/image/FalabellaPE/17899461?wid=75&amp;hei=75"
																					width="75" height="75"
																					class="jsx-2954533403 product-image"></a>
																			</div>
																			<div class="jsx-4094132561 jsx-232876397 cell">
																				<span><span id="display_name"
																					class="copy3 primary  jsx-2127020894 bold"><div
																							class="jsx-2954533403 product-name"><%=det.getDescripcion() %></div></span></span>
																				<div class="jsx-258848783  cell">
																					<span><span id="price"
																						class="copy5 primary  jsx-2127020894 bold">s/
																							<%=det.getPrecioUnidad() %></span></span>
																				</div>
																				<div class="jsx-3731310731  cell">
																					<div class="jsx-3975315105  cell">
																						<span><span id="brand_name"
																							class="copy3 quinary  jsx-2127020894 normal"><%=det.getCategoria() %></span></span>
																					</div>
																					<div class="jsx-2954533403">
																						<span><span id="ref-price"
																							class="copy3 quinary  jsx-2127020894 normal"><div
																									class="jsx-2954533403"></div></span></span>
																					</div>
																					<span><span id="quantity"
																						class="copy3 quinary  jsx-2127020894 normal"><%=det.getCantidad() %>
																							unidad</span></span>
																				</div>
																				<div class="jsx-998939448  cell">
																					<span><span id=""
																						class="copy3 primary  jsx-2127020894 bold"><div
																								class="jsx-2954533403">Vendido por</div></span></span>
																					<div
																						class="jsx-3881982095 container priority jsx-612022905">
																						<span><span id="brand_name"
																							class="copy3 quinary  jsx-2127020894 normal">Cibertec</span></span>
																					</div>
																				</div>
																			</div>
																		</div>
														...
														%>
														<div
															class="jsx-1389109146 jsx-34709862 orderLine-btn-container">
															<button type="button"
																class="jsx-1389109146 jsx-34709862 orderLines-btn">
																<div
																	class="jsx-1389109146 jsx-34709862 button-container">
																	<div class="jsx-1389109146 jsx-34709862 btn-text">Seguimiento
																		del envío</div>
																	<div class="jsx-1389109146 jsx-34709862 btn-icon">
																		<svg width="30" height="5" fill="none">
																			<path d="M8 4L4.5 1 1 4" stroke="#8A8A8A"
													...
													<div id="orderLine-in" class="jsx-1389109146 jsx-34709862" style="display: none;">
														<div
															class="jsx-2188447934 container priority jsx-3881482039">
															<div class="jsx-3645076099  cell">
																<h1
																	class="jsx-3564791919 title8 secondary highlighted  ">Despacho
																	a domicilio:</h1>
															</div>
															<div class="jsx-3975315105 jsx-3881482039 cell">
																<div class="jsx-2713504250 jsx-2101720754 cell">
																	<div
																		class="jsx-394126902 container priority jsx-648296455 jsx-1250808962">
																		<div class="jsx-3975315105 jsx-2531713091 cell">
																			<div
																				class="jsx-648296455 timeline-dot timeline-active"
																				style="left: calc(0% - 7px);"></div>
																			<div class="jsx-648296455 timeline-info"
																				style="left: 7%;">
																				<span class="jsx-648296455">Compra recibida
																					07/08</span>
																			</div>
																		</div>
																		<div class="jsx-3975315105 jsx-2531713091 cell">
																			<div
																				class="jsx-648296455 timeline-dot timeline-active"
																				style="left: calc(33.3333% - 7px);"></div>
																			<div class="jsx-648296455 timeline-info"
																				style="left: 40.3333%;">
																				<span class="jsx-648296455">Compra confirmada
																					07/08</span>
																			</div>
																		</div>
																		<div class="jsx-3975315105 jsx-2531713091 cell">
																			<div
																				class="jsx-648296455 timeline-dot timeline-active"
																				style="left: calc(66.6667% - 7px);"></div>
																			<div class="jsx-648296455 timeline-info"
																				style="left: 73.6667%;">
																				<span class="jsx-648296455">Compra en camino
																					10/08</span>
																			</div>
																		</div>
																		<div class="jsx-3975315105 jsx-2531713091 cell">
																			<div
																				class="jsx-648296455 timeline-dot timeline-current"
																				style="left: calc(100% - 7px);"></div>
																			<div class="jsx-648296455 timeline-info highlighted"
																				style="left: 107%;">
																				<span class="jsx-648296455">Compra entregada
																					10/08</span>
																			</div>
																		</div>
																		<div class="jsx-648296455 timeline-bar"></div>
																		<div class="jsx-648296455 timeline-progress"></div>
																	</div>
																</div>
																<div role="button" tabindex="0"
																	class="jsx-1389109146 jsx-34709862 shipment-details">
																	<span class="jsx-1389109146 jsx-34709862">Ver
																		detalle del envío</span>
																	<svg viewBox="0 0 32 32"
																		class="caret-right_svg__icon caret-right_svg__icon-chevron-right"
																		aria-hidden="true" width="20"
																		style="position: absolute; bottom: 47%; fill: rgb(73, 88, 103);">
																		<path
																			d="M18.629 15.997l-7.083-7.081L13.462 7l8.997 8.997L13.457 25l-1.916-1.916z"></path></svg>
																</div>
															</div>
															<div class="jsx-3820539480 jsx-2498501228 cell">
																<div class="jsx-3074345522  cell">
																	<span><span id="delivery-time"
																		class="copy3 primary  jsx-2127020894 normal"><span><span
																				id="address"
																				class="copy3 primary  jsx-2127020894 bold">Horario
																					de entrega: </span></span>Entre 08:00 a 20:00 horas.</span></span>
																</div>
															</div>
														</div>
													</div>
							...
							<div class="jsx-670243593 link-backToOrders-mobile">
								<div class="jsx-670243593 link-container">
									<a href="javascript:history.back()"
										class="jsx-670243593 rebranding-link-myOrders">Volver a
										Mis compras</a>
								</div>
							</div>
						</div>
